  ...
  return (
    ...
    <main id="top">
        ...
        <section id="projects" className="section container">
            ...
            <div className="grid">
                <a className="card" href="/Branding/Strategy">
                    <img src="https://picsum.photos/400/300" alt="Project 1 preview" />
                    <div className="card-body">
                        <div className="tag">Branding</div>
                        <h3>Strategy</h3>
                        <p>Read all about my branding strategy work.</p>
                    </div>
                </a>
        ...
        <section id="contact" className="section container">
            ...
            <div className="contact-grid">
                <a className="contact-card" href="mailto:yourname@email.com">
                    <p className="contact-label">Email</p>
                    <p className="contact-value">yourname@email.com</p>
                </a>
